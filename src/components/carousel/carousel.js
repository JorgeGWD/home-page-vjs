class Carousel extends HTMLElement {
    ...
    addEventListeners() {
        const prevButton = this.shadowRoot.querySelector('.carousel__button[data-action="prev"]');
        const nextButton = this.shadowRoot.querySelector('.carousel__button[data-action="next"]');
    ...
    updateSlider() {
        const slider = this.shadowRoot.querySelector('.carousel__slider');
        const cardWidth = this.shadowRoot.querySelector('.carousel__slider-card').offsetWidth;
